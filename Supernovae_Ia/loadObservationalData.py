...
def read_obs_data(path="observational_data"):
    ...
    z, ratenu, sys_err_p, sys_err_m, stat = loadtxt(f"{path}/SNIa_rate_frohmaier.dat", unpack=True)
    obs1_a = 1./(1.+z)
    ...
    z, ratenu, sys_err_p, sys_err_m, stat_p, stat_m = loadtxt(f"{path}/SNIa_rate_dilday.dat", unpack=True)
    obs2_a = 1./(1.+z)
    ...
    z, ratenu, sys_err_p, sys_err_m, stat_p, stat_m = loadtxt(f"{path}/SNIa_rate_perrett.dat", unpack=True)
    obs3_a = 1./(1.+z)
    err_p = (sys_err_p**2 + stat_p**2)**.5 * (h/0.7)**3
    err_m = (sys_err_m**2 + stat_m**2)**.5 * (h/0.7)**3
    ...
    z, ratenu, sys_err_p, sys_err_m = loadtxt(f"{path}/SNIa_rate_graur.dat", unpack=True)
    obs4_a = 1./(1.+z)
    ...
    z, ratenu, sys_err_p, sys_err_m, stat_p, stat_m = loadtxt(f"{path}/SNIa_rate_rodney.dat", unpack=True)
    obs5_a = 1./(1.+z)
    err_p = (sys_err_p**2 + stat_p**2)**.5 * (h/0.7)**3
    err_m = (sys_err_m**2 + stat_m**2)**.5 * (h/0.7)**3
